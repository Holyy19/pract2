...
namespace zadanie2
{
    class MainClass
    {
        ...
        {
          string result = "";
            string[] Russia = {"А","Б","В","Г","Д","Е","Ё","Ж","З","И","Й","К","Л","М","Н",
          "О","П","Р","С","Т","У","Ф","Х", "Ц", "Ч", "Ш", "Щ","Ъ", "Ы","Ь",
          "Э","Ю", "Я","а","б","в","г","д","е","ё","ж","з","и","й","к","л","м","н",
          "о","п","р","с","т","у","ф","х", "ц", "ч", "ш", "щ","ъ", "ы","ь",
          "э","ю", "я", " "};

            string[] English = {"A","B","V","G","D","E","E","ZH","Z","I","I","K","L","M","N",
          "O","P","R","S","T","U","F","KH","TS","CH","SH","SHCH","IE","Y",
                null,
          ...
          "e","iu","ya"," "}; 
            for (int i = 0; i < a.Length; i++)
            {
                ...
                {
                    if (a.Substring(i, 1) == Russia[j]) 
                    {
                        result = result + English[j];
                    }
                }
            }
            return result;
        ...
        public static void Main(string[] args)
        {
            ...
            string stroka = "";
            char find = 'f';
            Console.Write("Введите любую строку или слово: ");
